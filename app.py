        ...
        for folder in sorted(catalog.keys()):
            ...
            for p in products:
                ...
                rows += f'''<tr>
                  ...
                  <td style="text-align:center"><input class="qty-input" type="number" min="0" step="1" placeholder="0" data-id="{p["id"]}" data-price="{p["price"]}" data-name="{name_safe}" oninput="updateTotal()"></td>
